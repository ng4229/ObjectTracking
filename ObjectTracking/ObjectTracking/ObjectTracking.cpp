...
// ObjectTracking.cpp : Defines the class behaviors for the application.
//
...
// CObjectTrackingApp construction
...
// The one and only CObjectTrackingApp object

CObjectTrackingApp theApp;


// CObjectTrackingApp initialization
